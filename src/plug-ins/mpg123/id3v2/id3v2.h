...
#define ID3V2_FRAME_ID( a,b,c,d ) (( a << 24 ) | ( b << 16 ) | ( c << 8 ) | d )
...
/* Version 2.2.0 */
#define ID3V2_FRAME_ID_22( a, b, c ) (( a << 16 ) | ( b << 8 ) | c )
...
int id3v2_set_string( ID3V2_FRAME* frame, char* source );
...
void id3v2_set_save_charset( int charset );
