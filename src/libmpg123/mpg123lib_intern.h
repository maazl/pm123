...
#include "mpg123_config.h" /* PM123 specific configuration */
...
mpg123_off_t decoder_synth_bytes(mpg123_handle *fr , mpg123_off_t s);
...
mpg123_off_t outblock_bytes(mpg123_handle *fr, mpg123_off_t s);
