...
_INT123_dct64_3dnow
	...
	push	dword esi
	push	dword ebx
	lea	dword ebx, [esp+16]
	mov	dword edi, [esp+284]
	mov	dword ebp, [esp+276]
	mov	dword edx, [esp+280]
	lea	dword esi, [ebx+128]




	mov	dword eax, [_INT123_pnts]
	movq	mm0, [edi+0]
	movq	mm1, mm0
	movd	mm2, [edi+124]
	...
	mov	dword [edx+512], eax

	mov	dword eax, [ebx+16]
	mov	dword [ebp+768], eax
	mov	dword eax, [ebx+20]
	mov	dword [edx+256], eax

	mov	dword eax, [ebx+24]
	mov	dword [ebp+256], eax
	mov	dword eax, [ebx+28]
	mov	dword [edx+768], eax
