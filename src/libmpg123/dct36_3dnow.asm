...
_INT123_dct36_3dnow
	...
	movq	mm0, [eax+24]
	movq	mm1, [eax+48]
	movd	mm2, [_INT123_COS9+12]
	punpckldq	mm2, mm2
	movd	mm3, [_INT123_COS9+24]
	punpckldq	mm3, mm3
	pfmul	mm0, mm2
	pfmul	mm1, mm3
	push	dword eax
	...
	pop	dword eax
	movq	mm2, [eax+8]
	movd	mm3, [_INT123_COS9+4]
	punpckldq	mm3, mm3
	pfmul	mm2, mm3
	pfadd	mm2, mm0
	movq	mm3, [eax+40]
	movd	mm4, [_INT123_COS9+20]
	punpckldq	mm4, mm4
	pfmul	mm3, mm4
	pfadd	mm2, mm3
	movq	mm3, [eax+56]
	movd	mm4, [_INT123_COS9+28]
	punpckldq	mm4, mm4
	pfmul	mm3, mm4
	pfadd	mm2, mm3
	movq	mm3, [eax]
	movq	mm4, [eax+16]
	movd	mm5, [_INT123_COS9+8]
	punpckldq	mm5, mm5
	pfmul	mm4, mm5
	pfadd	mm3, mm4
	movq	mm4, [eax+32]
	movd	mm5, [_INT123_COS9+16]
	punpckldq	mm5, mm5
	pfmul	mm4, mm5
	pfadd	mm3, mm4
	pfadd	mm3, mm1
	movq	mm4, [eax+64]
	movd	mm5, [_INT123_COS9+32]
	punpckldq	mm5, mm5
	pfmul	mm4, mm5
	pfadd	mm3, mm4
	movq	mm4, mm2
	pfadd	mm4, mm3
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+0]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+108]
	...
	pfsub	mm4, mm2
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+32]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+140]
	...
	pfadd	mm4, mm3
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+4]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+112]
	...
	pfsub	mm4, mm2
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+28]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+136]
	...
	pfadd	mm4, mm3
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+8]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+116]
	...
	pfsub	mm4, mm2
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+24]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+132]
	...
	pfadd	mm4, mm3
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+12]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+120]
	...
	pfsub	mm4, mm2
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+20]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+128]
	...
	pfadd	mm4, mm3
	movq	mm5, mm7
	punpckldq	mm5, [_INT123_tfcos36+16]
	pfmul	mm4, mm5
	movq	mm5, mm4
	pfacc	mm5, mm5
	movd	mm6, [edx+124]
