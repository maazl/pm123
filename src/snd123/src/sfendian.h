...
#define endswap_double_array(ptr, len) endswap_int64_t_array ((void *)(ptr), len)
#define endswap_double_copy(dest, src, len) endswap_int64_t_copy ((int64_t *)(dest), (const int64_t *)(src), len)
#else
...
#define endswap_float_array(ptr, len) endswap_int_array ((void *)(ptr), len)
#define endswap_float_copy(dest, src, len) endswap_int_copy ((int *)(dest), (const int *)(src), len)
