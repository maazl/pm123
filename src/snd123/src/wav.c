...
{   int format, subformat, error, blockalign = 0, framesperblock = 0 ;
    ...
    {   if ((error = wav_read_header (psf, &blockalign, &framesperblock)) != 0)
            return error ;
        } ;
    ...
    {   psf_binheader_readf (psf, "m", &marker) ;
        ...
        {   case RIFF_MARKER :
            ...
            case fmt_MARKER :
                    ...
                    if ((error = wav_w64_read_fmt_chunk (psf, &wav_fmt, dword)) != 0)
                        return error ;
            ...
            case smpl_MARKER :
                    ...
                    if ((error = wav_read_smpl_chunk (psf, dword)) != 0)
                        return error ;
                    break ;
            ...
            case acid_MARKER :
                    ...
                    if ((error = wav_read_acid_chunk (psf, dword)) != 0)
                        return error ;
                    break ;
            ...
            case bext_MARKER :
                    ...
                    if ((error = wav_read_bext_chunk (psf, dword)) != 0)
                        return error ;
                    break ;
