...
#if HAVE_FLEXIBLE_ARRAY
#define peak_info_calloc(channels) ((PEAK_INFO*)calloc (1, sizeof (PEAK_INFO) + sizeof (PEAK_POS) * (channels)))
#else
#define peak_info_calloc(channels) ((PEAK_INFO*)calloc (1, sizeof (PEAK_INFO) + sizeof (PEAK_POS) * (channels-1)))
#endif
