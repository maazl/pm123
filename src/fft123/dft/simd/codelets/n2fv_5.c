...
/* Generated by: /homee/stevenj/cvs/fftw3.0.1/genfft/gen_notw_c -simd -compact -variables 4 -n 5 -name n2fv_5 -with-ostride 2 -include n2f.h */
...
/*
 * Generator Id's : 
 * $Id: n2fv_5.c,v 1.1 2005/07/26 17:36:59 glass Exp $
 * $Id: n2fv_5.c,v 1.1 2005/07/26 17:36:59 glass Exp $
 * $Id: n2fv_5.c,v 1.1 2005/07/26 17:36:59 glass Exp $
 */
...
static const kdft_desc desc = { 5, "n2fv_5", {13, 3, 3, 0}, &GENUS, 0, 2, 0, 0 };
void X(codelet_n2fv_5) (planner *p) {
     X(kdft_register) (p, n2fv_5, &desc);
}
