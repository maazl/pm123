...
CALL 'pipecmd' 'info meta 'dir'\data\test.wav'
CALL Parse result
CALL Check title, 'TestTitle1'
CALL Check artist, 'TestArtist1'
/* wav does not support album. CALL Check album, 'TestAlbum1' */
CALL Check year, '2011'
CALL Check comment, 'TestComment1'
/* need to create the apropriate tag in the file first. CALL Check genre, 'TestGenre1' */
/* wav does not support track. CALL Check track, '2' */
/* need to create the apropriate tag in the file first. CALL Check copyright, 'TestCopyright1' */
