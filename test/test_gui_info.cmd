...
/* tech info */
CALL CallPipe 'show techinfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 0'
CALL CallPipe 'hide techinfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 1'
CALL CallPipe 'isvisible techinfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 0'

/* tech info */
CALL CallPipe 'isvisible metainfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 0'
CALL CallPipe 'show metainfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 0'
CALL CallPipe 'show techinfo 'dir'\data\test.mp3'
CALL Assert 'RESULT', '= 0'
CALL CallPipe 'isvisible metainfo 'dir'\data\test.mp3'
